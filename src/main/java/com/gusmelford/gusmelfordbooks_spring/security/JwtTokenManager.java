...
public class JwtTokenManager {
    ...
    public JwtData generateToken(Authentication authentication) {
        ...
        Date date = new Date(System.currentTimeMillis() + TOKEN_VALIDITY*1000);
        ...
        jwtData.setAccessToken(token);
        jwtData.setExpiresIn(date.toString());
